from configuration import Albert, BaseDeDonnees, Configuration, Correspondance, Rula, charge_configuration
...
def test_configuration_constructible_avec_valeurs_custom():
    config = Configuration(
        ...
        albert=Albert(url="https://albert.example.com", cle_api="ma-cle", modele="openweight-large", modele_embeddings="bge"),
