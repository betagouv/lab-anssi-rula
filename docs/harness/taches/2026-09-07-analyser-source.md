...
- État du code : implémentation terminée sur `analyser-source`.
- Prochaine action : faire relire la PR #21.
- Risques ou limites : aucun changement backend prévu.

## Revue indépendante

- Diff examiné : [PR #21](https://github.com/betagouv/lab-anssi-rula/pull/21),
